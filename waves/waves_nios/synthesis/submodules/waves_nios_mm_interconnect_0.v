// waves_nios_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module waves_nios_mm_interconnect_0 (
		...
		output wire [1:0]  DAC_s1_address,                                   //                                     DAC_s1.address
		output wire        DAC_s1_write,                                     //                                           .write
		input  wire [31:0] DAC_s1_readdata,                                  //                                           .readdata
		output wire [31:0] DAC_s1_writedata,                                 //                                           .writedata
		output wire        DAC_s1_chipselect,                                //                                           .chipselect
		...
		output wire [23:0] sdram_controller_0_s1_address,                    //                      sdram_controller_0_s1.address
	...
	wire   [27:0] adc_0_adc_slave_agent_m0_address;                                                   // adc_0_adc_slave_agent:m0_address -> adc_0_adc_slave_translator:uav_address
	...
	wire  [104:0] adc_0_adc_slave_agent_rf_source_data;                                               // adc_0_adc_slave_agent:rf_source_data -> adc_0_adc_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] adc_0_adc_slave_agent_rsp_fifo_out_data;                                            // adc_0_adc_slave_agent_rsp_fifo:out_data -> adc_0_adc_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> adc_0_adc_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // adc_0_adc_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [6:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> adc_0_adc_slave_agent:cp_channel
	...
	wire   [31:0] dac_s1_agent_m0_readdata;                                                           // DAC_s1_translator:uav_readdata -> DAC_s1_agent:m0_readdata
	wire          dac_s1_agent_m0_waitrequest;                                                        // DAC_s1_translator:uav_waitrequest -> DAC_s1_agent:m0_waitrequest
	wire          dac_s1_agent_m0_debugaccess;                                                        // DAC_s1_agent:m0_debugaccess -> DAC_s1_translator:uav_debugaccess
	wire   [27:0] dac_s1_agent_m0_address;                                                            // DAC_s1_agent:m0_address -> DAC_s1_translator:uav_address
	wire    [3:0] dac_s1_agent_m0_byteenable;                                                         // DAC_s1_agent:m0_byteenable -> DAC_s1_translator:uav_byteenable
	wire          dac_s1_agent_m0_read;                                                               // DAC_s1_agent:m0_read -> DAC_s1_translator:uav_read
	wire          dac_s1_agent_m0_readdatavalid;                                                      // DAC_s1_translator:uav_readdatavalid -> DAC_s1_agent:m0_readdatavalid
	wire          dac_s1_agent_m0_lock;                                                               // DAC_s1_agent:m0_lock -> DAC_s1_translator:uav_lock
	wire   [31:0] dac_s1_agent_m0_writedata;                                                          // DAC_s1_agent:m0_writedata -> DAC_s1_translator:uav_writedata
	wire          dac_s1_agent_m0_write;                                                              // DAC_s1_agent:m0_write -> DAC_s1_translator:uav_write
	wire    [2:0] dac_s1_agent_m0_burstcount;                                                         // DAC_s1_agent:m0_burstcount -> DAC_s1_translator:uav_burstcount
	wire          dac_s1_agent_rf_source_valid;                                                       // DAC_s1_agent:rf_source_valid -> DAC_s1_agent_rsp_fifo:in_valid
	wire  [104:0] dac_s1_agent_rf_source_data;                                                        // DAC_s1_agent:rf_source_data -> DAC_s1_agent_rsp_fifo:in_data
	wire          dac_s1_agent_rf_source_ready;                                                       // DAC_s1_agent_rsp_fifo:in_ready -> DAC_s1_agent:rf_source_ready
	wire          dac_s1_agent_rf_source_startofpacket;                                               // DAC_s1_agent:rf_source_startofpacket -> DAC_s1_agent_rsp_fifo:in_startofpacket
	wire          dac_s1_agent_rf_source_endofpacket;                                                 // DAC_s1_agent:rf_source_endofpacket -> DAC_s1_agent_rsp_fifo:in_endofpacket
	wire          dac_s1_agent_rsp_fifo_out_valid;                                                    // DAC_s1_agent_rsp_fifo:out_valid -> DAC_s1_agent:rf_sink_valid
	wire  [104:0] dac_s1_agent_rsp_fifo_out_data;                                                     // DAC_s1_agent_rsp_fifo:out_data -> DAC_s1_agent:rf_sink_data
	wire          dac_s1_agent_rsp_fifo_out_ready;                                                    // DAC_s1_agent:rf_sink_ready -> DAC_s1_agent_rsp_fifo:out_ready
	wire          dac_s1_agent_rsp_fifo_out_startofpacket;                                            // DAC_s1_agent_rsp_fifo:out_startofpacket -> DAC_s1_agent:rf_sink_startofpacket
	wire          dac_s1_agent_rsp_fifo_out_endofpacket;                                              // DAC_s1_agent_rsp_fifo:out_endofpacket -> DAC_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> DAC_s1_agent:cp_valid
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> DAC_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // DAC_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> DAC_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> DAC_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> DAC_s1_agent:cp_endofpacket
	...
	wire  [104:0] sdram_controller_0_s1_agent_rf_source_data;                                         // sdram_controller_0_s1_agent:rf_source_data -> sdram_controller_0_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] sdram_controller_0_s1_agent_rsp_fifo_out_data;                                      // sdram_controller_0_s1_agent_rsp_fifo:out_data -> sdram_controller_0_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sdram_controller_0_s1_agent:cp_data
	...
	wire  [103:0] adc_0_adc_slave_agent_rp_data;                                                      // adc_0_adc_slave_agent:rp_data -> router_002:sink_data
	...
	wire          dac_s1_agent_rp_valid;                                                              // DAC_s1_agent:rp_valid -> router_007:sink_valid
	wire  [103:0] dac_s1_agent_rp_data;                                                               // DAC_s1_agent:rp_data -> router_007:sink_data
	wire          dac_s1_agent_rp_ready;                                                              // router_007:sink_ready -> DAC_s1_agent:rp_ready
	wire          dac_s1_agent_rp_startofpacket;                                                      // DAC_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          dac_s1_agent_rp_endofpacket;                                                        // DAC_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [103:0] sdram_controller_0_s1_agent_rp_data;                                                // sdram_controller_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire          dac_s1_agent_rdata_fifo_src_valid;                                                  // DAC_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] dac_s1_agent_rdata_fifo_src_data;                                                   // DAC_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          dac_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_005:in_0_ready -> DAC_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> DAC_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> DAC_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // DAC_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> DAC_s1_agent:rdata_fifo_sink_error
	wire          sdram_controller_0_s1_agent_rdata_fifo_src_valid;                                   // sdram_controller_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] sdram_controller_0_s1_agent_rdata_fifo_src_data;                                    // sdram_controller_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          sdram_controller_0_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_006:in_0_ready -> sdram_controller_0_s1_agent:rdata_fifo_src_ready
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pll_0_outclk0_clk),                                //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (dac_s1_agent_m0_address),                          // avalon_universal_slave_0.address
		.uav_burstcount         (dac_s1_agent_m0_burstcount),                       //                         .burstcount
		.uav_read               (dac_s1_agent_m0_read),                             //                         .read
		.uav_write              (dac_s1_agent_m0_write),                            //                         .write
		.uav_waitrequest        (dac_s1_agent_m0_waitrequest),                      //                         .waitrequest
		.uav_readdatavalid      (dac_s1_agent_m0_readdatavalid),                    //                         .readdatavalid
		.uav_byteenable         (dac_s1_agent_m0_byteenable),                       //                         .byteenable
		.uav_readdata           (dac_s1_agent_m0_readdata),                         //                         .readdata
		.uav_writedata          (dac_s1_agent_m0_writedata),                        //                         .writedata
		.uav_lock               (dac_s1_agent_m0_lock),                             //                         .lock
		.uav_debugaccess        (dac_s1_agent_m0_debugaccess),                      //                         .debugaccess
		.av_address             (DAC_s1_address),                                   //      avalon_anti_slave_0.address
		.av_write               (DAC_s1_write),                                     //                         .write
		.av_readdata            (DAC_s1_readdata),                                  //                         .readdata
		.av_writedata           (DAC_s1_writedata),                                 //                         .writedata
		.av_chipselect          (DAC_s1_chipselect),                                //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_0_outclk0_clk),                                //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (dac_s1_agent_m0_address),                          //              m0.address
		.m0_burstcount           (dac_s1_agent_m0_burstcount),                       //                .burstcount
		.m0_byteenable           (dac_s1_agent_m0_byteenable),                       //                .byteenable
		.m0_debugaccess          (dac_s1_agent_m0_debugaccess),                      //                .debugaccess
		.m0_lock                 (dac_s1_agent_m0_lock),                             //                .lock
		.m0_readdata             (dac_s1_agent_m0_readdata),                         //                .readdata
		.m0_readdatavalid        (dac_s1_agent_m0_readdatavalid),                    //                .readdatavalid
		.m0_read                 (dac_s1_agent_m0_read),                             //                .read
		.m0_waitrequest          (dac_s1_agent_m0_waitrequest),                      //                .waitrequest
		.m0_writedata            (dac_s1_agent_m0_writedata),                        //                .writedata
		.m0_write                (dac_s1_agent_m0_write),                            //                .write
		.rp_endofpacket          (dac_s1_agent_rp_endofpacket),                      //              rp.endofpacket
		.rp_ready                (dac_s1_agent_rp_ready),                            //                .ready
		.rp_valid                (dac_s1_agent_rp_valid),                            //                .valid
		.rp_data                 (dac_s1_agent_rp_data),                             //                .data
		.rp_startofpacket        (dac_s1_agent_rp_startofpacket),                    //                .startofpacket
		...
		.rf_sink_ready           (dac_s1_agent_rsp_fifo_out_ready),                  //         rf_sink.ready
		.rf_sink_valid           (dac_s1_agent_rsp_fifo_out_valid),                  //                .valid
		.rf_sink_startofpacket   (dac_s1_agent_rsp_fifo_out_startofpacket),          //                .startofpacket
		.rf_sink_endofpacket     (dac_s1_agent_rsp_fifo_out_endofpacket),            //                .endofpacket
		.rf_sink_data            (dac_s1_agent_rsp_fifo_out_data),                   //                .data
		.rf_source_ready         (dac_s1_agent_rf_source_ready),                     //       rf_source.ready
		.rf_source_valid         (dac_s1_agent_rf_source_valid),                     //                .valid
		.rf_source_startofpacket (dac_s1_agent_rf_source_startofpacket),             //                .startofpacket
		.rf_source_endofpacket   (dac_s1_agent_rf_source_endofpacket),               //                .endofpacket
		.rf_source_data          (dac_s1_agent_rf_source_data),                      //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                //                .error
		.rdata_fifo_src_ready    (dac_s1_agent_rdata_fifo_src_ready),                //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dac_s1_agent_rdata_fifo_src_valid),                //                .valid
		.rdata_fifo_src_data     (dac_s1_agent_rdata_fifo_src_data),                 //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dac_s1_agent_rsp_fifo (
		.clk               (pll_0_outclk0_clk),                                //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dac_s1_agent_rf_source_data),                      //        in.data
		.in_valid          (dac_s1_agent_rf_source_valid),                     //          .valid
		.in_ready          (dac_s1_agent_rf_source_ready),                     //          .ready
		.in_startofpacket  (dac_s1_agent_rf_source_startofpacket),             //          .startofpacket
		.in_endofpacket    (dac_s1_agent_rf_source_endofpacket),               //          .endofpacket
		.out_data          (dac_s1_agent_rsp_fifo_out_data),                   //       out.data
		.out_valid         (dac_s1_agent_rsp_fifo_out_valid),                  //          .valid
		.out_ready         (dac_s1_agent_rsp_fifo_out_ready),                  //          .ready
		.out_startofpacket (dac_s1_agent_rsp_fifo_out_startofpacket),          //          .startofpacket
		.out_endofpacket   (dac_s1_agent_rsp_fifo_out_endofpacket),            //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	waves_nios_mm_interconnect_0_router router (
	...
	waves_nios_mm_interconnect_0_router_001 router_001 (
	...
	waves_nios_mm_interconnect_0_router_002 router_002 (
	...
	waves_nios_mm_interconnect_0_router_002 router_003 (
	...
	waves_nios_mm_interconnect_0_router_004 router_004 (
	...
	waves_nios_mm_interconnect_0_router_002 router_005 (
	...
	waves_nios_mm_interconnect_0_router_002 router_006 (
	...
	waves_nios_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (dac_s1_agent_rp_ready),                            //      sink.ready
		.sink_valid         (dac_s1_agent_rp_valid),                            //          .valid
		.sink_data          (dac_s1_agent_rp_data),                             //          .data
		.sink_startofpacket (dac_s1_agent_rp_startofpacket),                    //          .startofpacket
		.sink_endofpacket   (dac_s1_agent_rp_endofpacket),                      //          .endofpacket
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_router_004 router_008 (
	...
	waves_nios_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (adc_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (adc_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_006 (
		.clk                (pll_0_outclk0_clk),                                //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	waves_nios_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	waves_nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dac_s1_agent_rdata_fifo_src_data),                 //     in_0.data
		.in_0_valid     (dac_s1_agent_rdata_fifo_src_valid),                //         .valid
		.in_0_ready     (dac_s1_agent_rdata_fifo_src_ready),                //         .ready
	...
	waves_nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                                // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sdram_controller_0_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (sdram_controller_0_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (sdram_controller_0_s1_agent_rdata_fifo_src_ready), //         .ready
